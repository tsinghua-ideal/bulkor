...
pub use position_map::{
    ORAMU32PositionMap, TrivialPositionMap, U32PositionMapCreator, POS_MAP_THRESHOLD,
};
    ...
    SC: ORAMStorageCreator<U4096, Prod<U2, DataMetaSize>, U2>,
{
    ...
    fn create<M: 'static + FnMut() -> R>(
        ...
        PathORAM::new::<
            U32PositionMapCreator<U2048, R, RecPathORAM4096Z2Creator<R, OcallORAMStorageCreator>>,
            SC,
            M,
    ...
    SC: ORAMStorageCreator<U4096, Prod<U4, DataMetaSize>, U4>,
{
    ...
    fn create<M: 'static + FnMut() -> R>(
        ...
        PathORAM::new::<
            U32PositionMapCreator<U1024, R, RecPathORAM4096Z4Creator<R, OcallORAMStorageCreator>>,
            SC,
            M,
        >(size, stash_size, rng_maker)
    }
...
mod testing {
    use super::*;
    use crate::oram_traits::{rng_maker, testing, HeapORAMStorageCreator, ORAM};
    use crate::test_helper::run_with_several_seeds;
    use crate::RngType;
